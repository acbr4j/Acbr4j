...
public class ControlTest extends TestCase {
	...
	public void testInstanciarControl() {
		...
		try {
			control = new ControllerECF( "br.com.otomatix.ecf.driver.ECFBematech" );
	...
	public void testProgramaHorarioVerao() {
		...
		ControllerECF control = new ControllerECF( "br.com.otomatix.ecf.driver.ECFBematech" );
	...
	public void testLeituraX() {
		...
		ControllerECF control = new ControllerECF( "br.com.otomatix.ecf.driver.ECFDaruma" );
