...
public abstract class AbstractECFDriver implements SerialPortEventListener, ParallelPortEventListener {
	...
	protected static int TIMEOUT_READ = 300;
	...
	public static final char EST_NAO_INICIALIZADA = 0;//Não Inicializada
	
	public static final char EST_DESCONHECIDO = 1;//Cupom Venda Aberto em Pagamento
	
	public static final char EST_LIVRE = 2;//Livre para vender
	
	public static final char EST_VENDA = 3;//Cupom Venda Aberto em Itens

	public static final char EST_PAGAMENTO = 4;//Cupom Venda Aberto em Pagamento
	
	public static final char EST_RELATORIO = 5;//Cupom Vinculado Aberto | Relatório Gerencial Aberto
	
	public static final char EST_BLOQUEADA = 6;//Impressora Bloqueada para venda

	public static final char EST_REQUERZ = 7;//Requer Emissão da Redução da Z

	public static final char EST_REQUERX = 8;//Requer Leitura X

	public static final char EST_NAO_FISCAL = 9;// Cupom Não Fiscal Aberto
	
	public static final char EST_SEM_PAPEL = 10;//Sem Papel
	...
	public abstract STResult linhaRelatorioGerencial(final String texto );
	

	public abstract STResult pulaLinhas(Integer numLinhas);
	...
	public abstract STResult vendaItem( String codProd, String descProd, String aliquota, float qtd, float valor, char tpdesc, float desconto );// 9

	
	public abstract STResult vendaItem( String codigo, String descricao, String aliquotaICMS, Double qtd, Double valorUnitario, Double valorDescontoAcrescimo,
    String unidade, String tipoDescontoAcrescimo, String descontoAcrescimo, Integer codDepartamento) ;
	
	
	public abstract STResult vendaItem( String qtd, String codProd, String valor, String unidade , String aliquota, String descProd);// 9
	...
	public abstract STResult abreRelatorioGerencial(Integer indice);
	public abstract String resultTotalPago();
